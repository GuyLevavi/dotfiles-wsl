...
check "fastfetch"  "$BIN/fastfetch --version"
check "mc"         "$BIN/mc --version"
...
check "bat --version"        "$BIN/bat --version"
check "rg --version"         "$BIN/rg --version"
check "fd --version"         "$BIN/fd --version"
check "eza --version"        "$BIN/eza --version"
check "lazygit --version"    "$BIN/lazygit --version"
check "delta --version"      "$BIN/delta --version"
check "uv --version"         "$BIN/uv --version"
check "glab --version"       "$BIN/glab --version"
check "helm version"         "$BIN/helm version --short"
check "oc version"           "$BIN/oc version --client"
check "fastfetch --version"  "$BIN/fastfetch --version"
check "mc --version"         "$BIN/mc --version"
check "nvim --version"       "$BIN/nvim --version"
